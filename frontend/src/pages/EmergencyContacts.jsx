...
export default function EmergencyContacts() {
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
      <h2 style={{ marginBottom: "5px" }}>Emergency Contacts & Authorities</h2>
        ...
        {contacts.map((contact) => (
          <div key={contact.id} style={{ border: "1px solid #e5e7eb", borderRadius: "8px", padding: "15px", backgroundColor: "#fff" }}>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <a href={`mailto:${contact.email}`} className="btn" style={{ textDecoration: "none", padding: "8px 12px", fontSize: "14px", border: "1px solid #ccc" }}>
                ✉️ Email
              </a>
            </div>
          </div>
